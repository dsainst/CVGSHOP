    ...
    $.fn.airStickyBlock = function(options) {
        $.airStickyBlock = function($this, options) {
            ...
            function airStickyGo() {
                ...
                if (settings.debug) {
                    $('#airSticky-debug').html('<p>windowHeight - ' + windowHeight + '</p>' + '<p>stopBlockHeight - ' + stopBlockHeight + '</p>' + '<p>stopBlockWidth - ' + stopBlockWidth + '</p>' + '<p>stopBlockOffset - ' + stopBlockOffset + '</p>' + '<p>stickyParentOffset - ' + stickyParentOffset + '</p>' + '<p>stickyParentWidth - ' + stickyParentWidth + '</p>' + '<p>stickyHeight - ' + stickyHeight + '</p>' + '<p>stickyWidth - ' + stickyWidth + '</p>' + '<p>stickyStop - ' + stickyStop + '</p>' + '<p>stickyStart - ' + stickyStart + '</p>' + '<p>stickyAbsolute - ' + stickyAbsolute + '</p>' + '<p>scrollTop - ' + scrollTop + '</p>');
                }
